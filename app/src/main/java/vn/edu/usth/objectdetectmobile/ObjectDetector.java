...
public class ObjectDetector implements AutoCloseable {
    public static class Detection {
        public final float x1,y1,x2,y2,score; public final int cls;
    ...
    public ObjectDetector(@NonNull Context ctx) throws OrtException {
        ...
        byte[] model = Util.readAllBytes(ctx.getAssets(), "yolov8n_int8_dynamic.onnx");
